...
import br.com.fiap.InovaTechDuo.repository.AlimentacaoRepository;
...
public class AlimentacaoController {
    ...
    @GetMapping
    public List<Alimentacao> index() {
        return repository.findAll();
    }

    @PostMapping
    @ResponseStatus(CREATED)
    public Alimentacao create(@RequestBody @Valid Alimentacao alimentacao) {
        return repository.save(alimentacao);
    }

    @GetMapping("{id}")
    public ResponseEntity<Alimentacao> show(@PathVariable Long id) {
    ...
    @PutMapping("{id}")
    public Alimentacao update(@PathVariable Long id, @RequestBody Alimentacao alimentacao) {
        log.info("atualizar cadastro {} para {}", id, alimentacao);
